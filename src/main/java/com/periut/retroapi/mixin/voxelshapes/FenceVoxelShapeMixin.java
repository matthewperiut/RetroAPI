...
public abstract class FenceVoxelShapeMixin extends Block implements HasVoxelShape, HasCollisionVoxelShape {
    @Unique
    ...
    public FenceVoxelShapeMixin(int id, Material material) {
        super(id, material);
    }

    @Unique
    private int retroapi$getVoxelDatumIndex(World world, int x, int y, int z) {
