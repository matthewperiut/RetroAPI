...
public class IntegerSuggestion extends Suggestion {
    ...
    public String toString() {
        return "IntegerSuggestion{value=" + value + ", range=" + getRange() + ", text='" + getText() + "', tooltip='" + getTooltip() + "'}";
    }

    /** Numeric suggestions sort by value, so 2 comes before 10 rather than after it. */
    @Override
