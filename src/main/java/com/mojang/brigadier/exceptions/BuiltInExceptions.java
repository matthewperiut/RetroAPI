...
/**
 * The stock error messages. The wording is Brigadier's, so a b1.7.3 player sees exactly the text a
 * modern player would - "Unknown command", "Incorrect argument for command", and so on.
 */
