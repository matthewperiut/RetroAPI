...
public class Suggestion implements Comparable<Suggestion> {
    ...
    /**
     * Widens this suggestion to cover {@code range}, pulling in whatever the command already had in
     * the extra span. Merging suggestions from several sources means normalising them all to one
     * range first.
     */
