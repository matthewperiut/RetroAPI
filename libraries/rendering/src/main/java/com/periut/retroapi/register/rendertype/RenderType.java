...
#if MC_VER >= 180
		idMap.put(RenderTypes.PANE, 18);
		idMap.put(RenderTypes.STEM, 19);
		idMap.put(RenderTypes.VINE, 20);
		idMap.put(RenderTypes.FENCE_GATE, 21);
		idMap.put(RenderTypes.BLOCK_ENTITY, 22);
#endif
#if MC_VER >= 190
		idMap.put(RenderTypes.LILY_PAD, 23);
		idMap.put(RenderTypes.CAULDRON, 24);
		idMap.put(RenderTypes.BREWING_STAND, 25);
		idMap.put(RenderTypes.END_PORTAL_FRAME, 26);
		idMap.put(RenderTypes.DRAGON_EGG, 27);
#endif
	}
